...
# on their loyalty card. The bonus is calculated with the following formula:
...
# Please fix the program so that there is always either a 10 % or a 
# 15 % bonus, but never both.
