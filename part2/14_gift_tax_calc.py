...
# to another person against no compensation or payment. If the total value of 
# the gifts you receive from the same donor in the course of 3 years is €5,000 or more, 
# you must pay gift tax.

# When the gift is received from a close relative or a family member, the amount of 
# tax to be paid is determined by the following table, which is also available on 
# this website:
...
# Notice the lack of thousands separators in the input values - you may assume 
# there will be no spaces or other thousands separators in the numbers in the input, 
