...
# integer numbers. The program should keep asking for 
# numbers until the user types in zero.
...
# You will need a new variable here to keep track of the 
# numbers typed in.
...
# Part 2: Sum
# The program should also print out the sum of all the 
# numbers typed in. The zero at the end should not be 
...
# You may assume the user will always type in at least one 
...
# The program should also print out statistics on how many 
# of the numbers were positive and how many were negative. 
# The zero at the end should not be included in the calculation.
